...
Description:      ��dts�ж�ȡap���ģ���dump�ڴ��С
Input:            NA
Output:           NA
Return:           0:��ȡ�ɹ�, ��0:ʧ��
********************************************************************************/
...
Description:      ��dts�ж�ȡap_last_task�ڴ����Ŀ���
Input:            NA
Output:           NA
Return:           0:��ȡʧ�ܻ򿪹عر�, ��0:���ش�
********************************************************************************/
...
void module_dump_mem_init(void)
{
	...
	/*ap_last_task_switch�ر�ʱ����last_task struct��stack��dump�ڴ���ʼ��ַ��0*/
...
Description:    ��ȡdumpģ���dump��ʼ��ַ��
Input:          modu:ģ��ID����Ϊͳһ����;
Output:         dump_addr:�ѷ����ģ��modu��dump�ڴ���ʼ��ַ
Return:         0:��ȡ�ɹ���С��0:��ȡʧ��
********************************************************************************/
