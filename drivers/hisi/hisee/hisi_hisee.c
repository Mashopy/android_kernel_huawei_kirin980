...
static hisee_driver_function g_hisee_atf_function_list[] = {
	...
	{"inse_shutdown_swipe_t_pmu_en", inse_shutdown_swipe_t_nfc_en_func}, /* ��ػ�ˢ����ʹ��PMU��ӦNFCָʾ�ź� */
	{"inse_shutdown_swipe_t_pmu_dis", inse_shutdown_swipe_t_nfc_dis_func}, /* ��ػ�ˢ������ֹPMU��ӦNFCָʾ�ź� */
...
/***************************************************************************
* ������int hisee_get_smx_cfg(unsigned int *p_smx_cfg)
* ��������
* ���أ���ȡsmx״̬:TRUE or FALSE;
* ������ͨ��SMC��ATF������ȡsmx״̬�����
* ʵ�֣�
***************************************************************************/
...
/*************************************************************
����ԭ�ͣ�int cos_image_upgrade_by_self(void)
�������ܣ�ִ�ж�cos�����������������hisee.img�����ÿһ��cos�����ļ�����cos��������������
������
���룺��
������ޡ�
����ֵ��HISEE_OK:��cos���������ɹ�������HISEE_OK:��cos��������ʧ��
ǰ��������hisee_img����д������Ч��hisee.img�ļ�
���������� ��
*************************************************************/
 ...
 * @param[in]  : pdev
 * @return     : int
 * @note       : ���ӱ�������ԭ����hisee_probe()Ȧ���Ӷȳ���15����Ҫ��ֺ���������Ȧ���Ӷ�
********************************************************************************/
