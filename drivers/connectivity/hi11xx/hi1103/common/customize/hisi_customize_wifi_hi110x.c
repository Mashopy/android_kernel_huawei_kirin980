 ...
 */
int32 g_al_host_init_params_etc[WLAN_CFG_INIT_BUTT] = {0};      /* ini���ƻ��������� */
int32 g_al_dts_params_etc[WLAN_CFG_DTS_BUTT] = {0};             /* dts���ƻ��������� */
int8  g_ac_country_code_etc[COUNTRY_CODE_LEN] = "00";
uint8 g_auc_wifimac_etc[MAC_LEN] = {0x00,0x00,0x00,0x00,0x00,0x00};
int32 g_al_nvram_init_params[NVRAM_PARAMS_PWR_INDEX_BUTT] = {0};    /* ini�ļ���NV�������� */
wlan_customize_private_stru g_al_priv_cust_params[WLAN_CFG_PRIV_BUTT] = {{0,0}};  /* ˽�ж��ƻ��������� */
wlan_cust_country_code_ingore_flag_stru g_st_cust_country_code_ignore_flag = {0}; /* ���ƻ����������� */
wlan_cust_nvram_params g_st_cust_nv_params  = {{0}};  /* ����͹��ʶ��ƻ����� */
wlan_customize_pwr_fit_para_stru g_ast_pro_line_params[WLAN_RF_CHANNEL_NUMS][DY_CALI_PARAMS_NUM] = {{{0}}};    /* ���ⶨ�ƻ��������� */
uint8 g_auc_cust_nvram_info[WLAN_CFG_DTS_NVRAM_END][CUS_PARAMS_LEN_MAX] = {{0}};  /* NVRAM���� */
oal_bool_enum_uint8 g_en_nv_dp_init_is_null = OAL_TRUE;      /* NVRAM��dp init�ÿձ�־ */
...
oal_bool_enum_uint8 g_uc_wlan_cal_intvl_enable = OAL_TRUE; /* ʹ�ܿ�wifi�ظ�У׼�ļ�� */
...
OAL_STATIC oal_void host_params_init_first(oal_void)
{
    ...
    /* ldac m2s rssi */
    g_al_host_init_params_etc[WLAN_CFG_INIT_LDAC_THRESHOLD_M2S]            = -45;  /* Ĭ��������ޣ���֧�� */
...
{
    oal_int8 ast_ldac_m2s_rssi_threshold[WLAN_M2S_LDAC_RSSI_BUTT] = {0,0}; /* ��ǰm2s��s2m���ޣ�������չ������ö�� */
