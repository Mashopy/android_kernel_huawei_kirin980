                                        ...
                                        oal_uint16                              us_user_idx)
{
    ...
    if (OAM_USER_TRACK_FRAME_TYPE_MGMT == en_frame_type)
    {
        g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch = en_frame_switch;/* [false alarm]:���������жϣ�����Խ��*/
        g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch = en_cb_switch;/* [false alarm]:���������жϣ�����Խ��*/
        g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch = en_dscr_switch;/* [false alarm]:���������жϣ�����Խ��*/
    }
    else
    {
        g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch = en_frame_switch;/* [false alarm]:���������жϣ�����Խ��*/
        g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch = en_cb_switch;/* [false alarm]:���������жϣ�����Խ��*/
        g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch = en_dscr_switch;/* [false alarm]:���������жϣ�����Խ��*/
                                        ...
                                        oal_uint16                              us_user_idx)
{
    ...
    if (OAM_USER_TRACK_FRAME_TYPE_MGMT == en_frame_type)
    {
        *pen_frame_switch = g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch;/* [false alarm]:���������жϣ�����Խ��*/
        *pen_cb_switch    = g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch;/* [false alarm]:���������жϣ�����Խ��*/
        *pen_dscr_switch  = g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch;/* [false alarm]:���������жϣ�����Խ��*/
    }
    else
    {
        *pen_frame_switch = g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch;/* [false alarm]:���������жϣ�����Խ��*/
        *pen_cb_switch    = g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch;/* [false alarm]:���������жϣ�����Խ��*/
        *pen_dscr_switch  = g_st_oam_mng_ctx_etc.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch;/* [false alarm]:���������жϣ�����Խ��*/
    }
