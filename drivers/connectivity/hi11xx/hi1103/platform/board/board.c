...
static uint32 g_halt_det_cnt = 0;/*���soc�쳣����*/
...
uint32 g_ssi_clk_etc  = 0;              /*ģ��ssiʱ�ӵ�GPIO�ܽź�*/
uint32 g_ssi_data_etc = 0;              /*ģ��ssi�����ߵ�GPIO�ܽź�*/
uint16 g_ssi_base_etc = 0x8000;         /*ssi��ַ*/
uint32 g_interval_etc = INTERVAL_TIME;  /*GPIO�������Ĳ��α���ʱ�䣬��λus*/
...
/*32bits address,
  32bits value
  gpioģ��SSI ��32BIT value
  1.����SSI Ϊ32BITģʽ
  2.��һ�ζ�16BIT������SOC����32BIT���������ص�16BIT��HOST
  3.�ڶ��ζ�ͬһ��ַ16BIT������SOC���������߲��������ظ�16BIT��HOST
  4.�����������3 ��������ַ��SOC���16BIT �ᱻ����*/
...
int32 do_ssi_mem_test(ssi_trans_test_st* pst_ssi_test)
{
    ...
    {
        ul_addr = ul_write_base + 2*i;  //��2�ֽڶ�д
...
ssi_reg_info hi1103_pcie_dbi_full = {0x40102000, 0x900, SSI_RW_DWORD_MOD};/*û����֮ǰ���ܶ�*/
...
{
    /*tcxo detect ����tcxoʱ�ӣ�
       �����������tcxo �쳣��ôtcxo_32k_det_result Ϊ��ֵ
       �����������32k�쳣 ��ôsytem_tickΪ��ֵ*/
    int ret  = 0;
    char* tcxo_str = "";
    ...
    ssi_write32_etc(0x500000c0, 0x2);/*����w systick*/
