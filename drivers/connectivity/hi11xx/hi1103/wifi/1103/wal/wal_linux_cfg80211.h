...
#define WAL_COOKIE_FULL_MASK            0xFF    /* cookieȫ���þ����� */
...
#define WAL_VOWIFI_GET_STATION_THRESHOLD 200  /*������vowifi����ʹ��ʱ*/
...
#if ((_PRE_PRODUCT_ID != _PRE_PRODUCT_ID_HI1151) || ((_PRE_CONFIG_TARGET_PRODUCT != _PRE_TARGET_PRODUCT_TYPE_E5) && (_PRE_CONFIG_TARGET_PRODUCT != _PRE_TARGET_PRODUCT_TYPE_CPE)))//E5��hostapd�����ͳһ����
