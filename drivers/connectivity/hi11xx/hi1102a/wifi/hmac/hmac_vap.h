...
typedef struct hmac_vap_tag
{
    ...
    oal_uint8                       bit_11k_auth_flag       :   1;             /* 11k ��֤��־λ*/
    oal_uint8                       bit_voe_11r_auth        :   1;
    oal_uint8                       bit_11k_auth_oper_class :   2;
    oal_uint8                       bit_11r_over_ds         :   1;             /*�Ƿ�ʹ��11r over ds��0��ʾover ds��over air����*/
    ...
    oal_uint16                      us_rx_timeout_min[WLAN_WME_AC_BUTT];            /* ��ͬҵ��������ʱʱ�� */
    ...
    oal_bool_enum_uint8               en_small_amsdu_switch;                   /* С��amsdu�ۺϵĿ��� */
    ...
    oal_uint32                       ul_check_timer_pause_cnt;                   /* �͹���pause���� */
#endif
