...
int32 plat_exception_handler(uint32 subsys_type, uint32 thread_type, uint32 exception_type)
{
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_PLAT, CHR_LAYER_DRV, CHR_WIFI_DRV_EVENT_PLAT, CHR_WIFI_DRV_ERROR_EXCEPTION_HANDLE);
...
int32 wifi_exception_handler(void)
{
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DRV, CHR_WIFI_DRV_EVENT_EXCEPTION, CHR_WIFI_DRV_ERROR_EXCEPTION_WIFI_HANDLE);
...
int32 wifi_subsystem_reset(void)
{
    ...
    switch (l_subchip_type)
    {
        ...
        case BOARD_VERSION_HI1102A:
            ...
            if (EXCEPTION_SUCCESS != hi1102a_wifi_subsys_reset())
			{
			    PS_PRINT_ERR("wifi reset failed\n");
                return -EXCEPTION_FAIL;
			}
...
int32 wifi_device_reset(void)
{
    ...
    else if (BOARD_VERSION_HI1103 == l_subchip_type)/*1103 ͨ��w_en��λ*/
    {
    ...
    else if (BOARD_VERSION_HI1102A == l_subchip_type)/*1102a ͨ��w_en��λ*/
    {
        PS_PRINT_INFO("reset wifi device by w_en gpio\n");
...
int32 bfgx_subsystem_reset(void)
{
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DRV, CHR_WIFI_DRV_EVENT_PLAT, CHR_WIFI_DRV_ERROR_BFGX_SUB_SYSTEM_RESET);
...
int32 bfgx_system_reset(void)
{
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DRV, CHR_WIFI_DRV_EVENT_PLAT, CHR_WIFI_DRV_ERROR_BFGX_SYSTEM_RESET);
